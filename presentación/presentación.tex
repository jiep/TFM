...
\begin{minipage}{0.65\textwidth}
	\begin{figure}[htbp!]
		\centering
		\resizebox{0.4\textheight}{!}{\includegraphics{imagenes/iris_dendrogram.png}}
...
\begin{frame}{Aprendizaje por refuerzo}
	...
	\begin{figure}[htbp!]
			\centering
			\resizebox{!}{0.5\textwidth}{\includegraphics{imagenes/reinforcement_learning.jpg}}
...
\begin{frame}{Algunos algoritmos}
	...
	\begin{minipage}{0.65\textwidth}
		\begin{figure}[htbp!]
			\centering
			\resizebox{0.5\textheight}{!}{\includegraphics{imagenes/breakout.png}}
